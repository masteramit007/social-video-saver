...
export const routes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: "/download/japan", element: <RegionPage /> },
      { path: "/download/brazil", element: <RegionPage /> },
      { path: "/download/sea", element: <RegionPage /> },
      { path: "/download/turkey", element: <RegionPage /> },
      { path: "/download/usa", element: <RegionPage /> },
